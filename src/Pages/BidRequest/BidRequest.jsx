...
const BidRequest = () => {
  ...
  // const url = `https://marketeers-hub-auth-jwt-server.vercel.app/apply_buyer?email=${user?.email}`;
  ...
  const handleSelectedConform = (id) => {
    fetch(`https://marketeers-hub-auth-jwt-server.vercel.app/apply_buyer/${id}`, {
      method: "PATCH",
      headers: {
